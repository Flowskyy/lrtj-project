...
export default function AddBannerContent() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-semibold text-gray-900">Add Banner</h1>
        <p className="text-base text-gray-500 mt-2">Create a new banner image</p>
      </div>

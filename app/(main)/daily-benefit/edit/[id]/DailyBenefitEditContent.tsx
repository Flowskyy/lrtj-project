...
export default function DailyBenefitEditContent({ userEmail, dailyBenefitId }: DailyBenefitEditContentProps) {
  ...
  const proceedWithSave = async (termConditionOverride?: string) => {
